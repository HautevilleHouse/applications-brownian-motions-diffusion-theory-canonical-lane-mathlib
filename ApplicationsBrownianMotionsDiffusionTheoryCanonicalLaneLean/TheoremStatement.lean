...
def sourceRepository : String := "applications-brownian-motions-diffusion-theory-canonical-lane"
def sourceDescription : String := "Applications Brownian Motions Diffusion Theory"
def sourceTheoremBoundary_claimBoundary : String := "classical source boundary"
